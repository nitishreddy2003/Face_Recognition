...
const Homepage = (props) => {
    ...
    return (
        <div className="home">
            ...
            <br />
            <Grid container spacing={2} style={{ paddingLeft: "30px", paddingTop: "10px", border:"" }}>
                <Grid xs={11}>
            ...
            <div style={{border:"", display:"flex", flexDirection:"row", justifyContent:"center", alignItems:"center" }}>
            ...
            {processing1 && processing2 ? (<h1>processing.......</h1>) :
                (<div>
                    ...
                    <Grid container spacing={2} style={{ paddingLeft: "200px", paddingTop: "10px", border:"" }}>
                        <Grid xs={8}>
                            <div>
